...
> **KuringCommons**는 쿠링 앱에 사용되는 공통 UI 요소와 로깅에 대한 가이드를 제공하는 쿠링 iOS 만의 소프트웨어 개발 키트 입니다. 개발 문서는 [여기에서](https://ku-stacks.github.io/kuring-ios-commons/documentation/kuringcommons/) 확인할 수 있습니다.
>
